...
local theme_path = configDir .. "theme/"
...
theme.taglist_font  = font .. " " .. size

theme.bg_normal     = "#222222" -- original
theme.bg_normal     = "#350035" -- mine
theme.bg_focus      = "#535d6c" -- original
theme.bg_focus      = "#700070" -- min
...
theme.wallpaper = theme_path.."farewell.jpg"
